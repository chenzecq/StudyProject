...
@WebAppConfiguration
public class ZhouchaoguangWSImplTest extends AbstractJUnit4SpringContextTests {
    public static class SimpleServer extends AbstractBusTestServerBase {

        @Override
        protected void run() {
            Object object = new ZhouChaoGuangWSImpl();
            String address = "http://localhost:" + 8080 + "/soap/ZhouchaoguangWS";
    ...
    public void sendMsg() throws Exception {
        ...
        Client client=factory.createClient("http://localhost:8080/soap/ZhouchaoguangWS?wsdl");
