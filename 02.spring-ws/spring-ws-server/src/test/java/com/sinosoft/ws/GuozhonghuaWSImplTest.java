...
@WebAppConfiguration
public class GuozhonghuaWSImplTest extends AbstractJUnit4SpringContextTests {

    public static class SimpleServer extends AbstractBusTestServerBase{
        protected void run() {
            Object implementor = new GuozhonghuaWSImpl();
            String address = "http://localhost:" + 8080 + "/soap/GuozhonghuaWS";
    ...
    public void sendMsg() throws Exception {
        ...
        Client client = dynamicClient.createClient("http://localhost:8080/soap/GuozhonghuaWS?wsdl");
