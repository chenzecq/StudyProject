...
/**
 * Created by zhangjd on 2017/2/19.
 */
...
@WebAppConfiguration
public class ZhangjdWSImplTest extends AbstractJUnit4SpringContextTests {

    public static class SimpleServer extends AbstractBusTestServerBase{
        protected void run() {
            Object implementor = new ZhangjdWSImpl();
            String address = "http://localhost:" + 8080 + "/soap/ZhangjdWS";
    ...
    public void sendMsg() throws Exception {
        ...
        Client client = dynamicClient.createClient("http://localhost:8080/soap/ZhangjdWS?wsdl");
        Object[] objects = client.invoke("sendMsg", "测试接口完成");
        assertTrue(objects!=null);
        assertTrue(objects.length==1);
        assertTrue(objects[0]!=null);
        assertTrue(objects[0].equals("测试接口完成"));
