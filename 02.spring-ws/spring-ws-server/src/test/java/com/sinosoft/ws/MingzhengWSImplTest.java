...
@WebAppConfiguration
public class MingzhengWSImplTest extends AbstractJUnit4SpringContextTests {

    public static class SimpleServer extends AbstractBusTestServerBase{
        protected void run() {
            Object implementor = new MingzhengWSImpl();
            String address = "http://localhost:" + 8080 + "/soap/MingzhengWS";
    ...
    public void sendMsg() throws Exception {
        ...
        Client client = dynamicClient.createClient("http://localhost:8080/soap/MingzhengWS?wsdl");
