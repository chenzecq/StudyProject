...
@WebAppConfiguration
public class GuoruisongWSImplTest extends AbstractJUnit4SpringContextTests {
    ...
    public void sendMsg() throws Exception {
        ...
        Client client = dynamicClient.createClient("http://localhost:8080/soap/GuoruisongWS?wsdl");
        Object[] objects = client.invoke("sendMsg", "grs");//调用ws的sendMsg("0204")方法
        assertTrue(objects!=null);
        assertTrue(objects.length==1);
        assertTrue(objects[0]!=null);
        assertTrue(objects[0].equals("grs"));
