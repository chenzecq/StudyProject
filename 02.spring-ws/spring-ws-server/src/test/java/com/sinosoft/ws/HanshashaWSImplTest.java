...
@WebAppConfiguration
public class HanshashaWSImplTest extends AbstractJUnit4SpringContextTests{

    //内部类
    public static class SimpleServer extends AbstractBusTestServerBase{
        @Override
        protected void run() {
            Object implementor = new HanshashaWSImpl();
            String address = "http://localhost:" + 8080 + "/soap/HanshashaWS";
    ...
    public void sendMsg() throws Exception {
        ...
        Client client = dynamicClient.createClient("http://localhost:8080/soap/HanshashaWS?wsdl");
        Object[] objects = client.invoke("sendMsg", "0217");
        assertTrue(objects!=null);
        assertTrue(objects.length==1);
        assertTrue(objects[0]!=null);
        assertTrue(objects[0].equals("0217"));
