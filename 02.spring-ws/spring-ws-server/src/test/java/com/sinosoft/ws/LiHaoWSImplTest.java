...
@WebAppConfiguration
public class LiHaoWSImplTest extends AbstractJUnit4SpringContextTests {

    public static class SimpleServer extends AbstractBusTestServerBase{
        protected void run() {
            Object implementor = new LiHaoWSImpl();
            String address = "http://localhost:" + 8080 + "/soap/LiHaoWS";
    ...
    public void sendMsg() throws Exception {
        ...
        Client client = dynamicClient.createClient("http://localhost:8080/soap/LiHaoWS?wsdl");
