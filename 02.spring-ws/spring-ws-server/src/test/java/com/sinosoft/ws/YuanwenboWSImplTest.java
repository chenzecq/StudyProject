...
@WebAppConfiguration
public class YuanwenboWSImplTest extends AbstractJUnit4SpringContextTests {

    public static class SimpleServer extends AbstractBusTestServerBase{
        protected void run() {
            Object implementor = new YuanwenboWSImpl();
            String address = "http://localhost:" + 8080 + "/soap/YuanwenboWS";
    ...
    public void sendMsg() throws Exception {
        ...
        Client client = dynamicClient.createClient("http://localhost:8080/soap/YuanwenboWS?wsdl");
