...
public class WeixiangyouControllerTest extends AbstractJUnit4SpringContextTests {
    @Autowired
    private WebApplicationContext wac;
    private MockMvc mockMvc;//实现了对Http请求的模拟，能够直接使用网络的形式，转换到Controller的调用
    @Test
    public void helloWeixiangyou() throws Exception {


        this.mockMvc.perform(
                MockMvcRequestBuilders
                        .get("/weixiangyou/helloworld")//相当于在浏览器地址栏中输入请求地址
    ...
    //在执行测试方法helloWeixiangyou前，首先要创建MockMvc
    @Before
    public void setup() {
